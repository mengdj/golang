...
type Head struct {
	...
	Cmd    *string `protobuf:"bytes,1,req,name=cmd,def=CMD" json:"cmd,omitempty"`
	Length *uint32 `protobuf:"varint,2,opt,name=length,def=0" json:"length,omitempty"`
}

// Default values for Head fields.
const (
	Default_Head_Cmd    = string("CMD")
	Default_Head_Length = uint32(0)
)
...
func (x *Head) GetCmd() string {
	...
	return Default_Head_Cmd
}

func (x *Head) GetLength() uint32 {
	if x != nil && x.Length != nil {
		return *x.Length
	}
	return Default_Head_Length
}

var File_head_proto protoreflect.FileDescriptor

var file_head_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x68, 0x65, 0x61, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x70, 0x72,
	0x6f, 0x63, 0x22, 0x38, 0x0a, 0x04, 0x48, 0x65, 0x61, 0x64, 0x12, 0x15, 0x0a, 0x03, 0x63, 0x6d,
	0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x3a, 0x03, 0x43, 0x4d, 0x44, 0x52, 0x03, 0x63, 0x6d,
	0x64, 0x12, 0x19, 0x0a, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0d, 0x3a, 0x01, 0x30, 0x52, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68,
}
